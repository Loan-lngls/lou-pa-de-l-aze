...
(function () {
  ...
  var T = [
    ...
    ["Que vous partiez pour une randonnée en famille avec un âne le temps d'une demi-journée ou pour un véritable trek de plusieurs jours, votre âne bâté vous accompagne sur les sentiers du Parc National des Écrins, entre Valbonnais et la Matheysine. Une activité en famille accessible aux petits comme aux grands, à savourer à votre rythme.",
      "Whether you're setting off for a family hike with a donkey lasting half a day, or a true multi-day trek, your pack donkey accompanies you along the trails of the Écrins National Park, between Valbonnais and the Matheysine. A family-friendly activity for all ages, enjoyed at your own pace.",
      "Ob Sie sich für eine halbtägige Familienwanderung mit einem Esel entscheiden oder für einen echten mehrtägigen Trek: Ihr Packesel begleitet Sie auf den Wegen des Nationalparks Écrins, zwischen Valbonnais und der Matheysine. Eine familienfreundliche Aktivität für Groß und Klein, in Ihrem eigenen Tempo."],
    ["Depuis", "Since", "Seit"],
    ...
    // ---- Accueil : FAQ ----
    ["Questions fréquentes", "Frequently asked questions", "Häufig gestellte Fragen"],
    ["Vos questions sur la randonnée avec un âne", "Your questions about hiking with a donkey", "Ihre Fragen zur Wanderung mit einem Esel"],
    ["Où faire une randonnée avec un âne dans les Écrins ?",
      "Where can you go hiking with a donkey in the Écrins?",
      "Wo kann man in den Écrins mit einem Esel wandern?"],
    ["Lou Pa de l'Aze vous accueille à Péchal, un hameau de la commune de Valbonnais, aux portes du Parc National des Écrins et de la Matheysine, en Isère. C'est depuis cette base que partent toutes nos randonnées avec un âne, de la simple balade en famille au grand trek de plusieurs jours.",
      "Lou Pa de l'Aze welcomes you in Péchal, a hamlet in the commune of Valbonnais, at the gateway to the Écrins National Park and the Matheysine, in the Isère. All our donkey hikes set off from this base, from a simple family outing to a full multi-day trek.",
      "Lou Pa de l'Aze empfängt Sie in Péchal, einem Weiler der Gemeinde Valbonnais, an den Toren des Nationalparks Écrins und der Matheysine, im Département Isère. Von diesem Standort aus starten alle unsere Eselwanderungen, vom einfachen Familienausflug bis zum großen mehrtägigen Trek."],
    ["Quelle est la durée d'une randonnée avec un âne ?",
      "How long does a donkey hike last?",
      "Wie lange dauert eine Wanderung mit einem Esel?"],
    ["Nos parcours vont de la demi-journée à des itinérances de 2 à 7 jours ou plus. Vous pouvez choisir une sortie courte pour découvrir l'âne bâté en famille, ou partir sur un trek sur-mesure au rythme qui vous convient.",
      "Our routes range from a half-day to self-guided journeys of 2 to 7 days or more. You can choose a short outing to discover the pack donkey as a family, or set off on a tailor-made trek at the pace that suits you.",
      "Unsere Touren reichen von einem halben Tag bis zu eigenständigen Touren von 2 bis 7 Tagen oder mehr. Sie können einen kurzen Ausflug wählen, um den Packesel mit der Familie zu entdecken, oder sich auf einen maßgeschneiderten Trek in Ihrem eigenen Tempo begeben."],
    ["Faut-il être sportif pour randonner avec un âne ?",
      "Do you need to be sporty to hike with a donkey?",
      "Muss man sportlich sein, um mit einem Esel zu wandern?"],
    ["Pas nécessairement : nos randonnées faciles et nos sorties à la journée conviennent aux familles avec enfants, sans condition physique particulière. Les treks de plusieurs jours dans le Parc National des Écrins demandent en revanche un peu plus d'endurance.",
      "Not necessarily: our easy hikes and day outings suit families with children, with no particular fitness required. Multi-day treks in the Écrins National Park do call for a bit more stamina.",
      "Nicht unbedingt: Unsere leichten Wanderungen und Tagesausflüge eignen sich für Familien mit Kindern, ohne besondere körperliche Voraussetzungen. Mehrtägige Treks im Nationalpark Écrins erfordern dagegen etwas mehr Ausdauer."],
    ["Une randonnée avec un âne convient-elle aux enfants ?",
      "Is a donkey hike suitable for children?",
      "Eignet sich eine Eselwanderung für Kinder?"],
    ["Oui, c'est même l'une des activités en famille les plus appréciées en Isère : l'âne porte les bagages pendant que petits et grands profitent du chemin. Nos balades les plus courtes, comme le tour du Lac de Valbonnais, sont pensées pour une première expérience en famille.",
      "Yes, it's one of the most popular family activities in the Isère: the donkey carries the luggage while young and old enjoy the trail. Our shortest outings, like the Lake Valbonnais loop, are designed as a first family experience.",
      "Ja, es ist sogar eine der beliebtesten Familienaktivitäten in der Isère: Der Esel trägt das Gepäck, während Groß und Klein den Weg genießen. Unsere kürzesten Ausflüge, wie die Runde um den Lac de Valbonnais, sind für ein erstes Familienerlebnis konzipiert."],
    // ---- Randonnées ----
    ["Itinéraires", "Routes", "Routen"],
    ["À la journée", "Day outings", "Tagestouren"],
    ["Demi-journée & journée", "Half-day & full-day", "Halbtags & ganztags"],
    ["Des sorties de randonnée en famille avec un âne, accessibles à tous, le temps d'une demi-journée ou d'une journée complète pour découvrir la marche aux côtés de votre âne bâté.",
      "Family hikes with a donkey, suitable for everyone, for a half-day or a full day, to discover walking alongside your pack donkey.",
      "Familienwanderungen mit einem Esel, für alle geeignet, halbtags oder ganztags, um das Wandern an der Seite Ihres Packesels zu entdecken."],
    ...
    ["De 2 à 7 jours ou plus, nous construisons avec vous une itinérance sur mesure au cœur du Parc National des Écrins et de la Matheysine : durée, niveau, étapes en refuge ou en bivouac, au rythme qui vous convient. L'âne bâté porte les bagages, vous n'avez plus qu'à avancer. Dites-nous vos envies, on dessine le parcours.",
      "From 2 to 7 days or more, we build a tailor-made journey with you through the heart of the Écrins National Park and the Matheysine: length, level, stages in mountain huts or bivouac, at the pace that suits you. The pack donkey carries the luggage, you just walk. Tell us what you're after and we'll map out the route.",
      "Von 2 bis 7 Tagen oder mehr gestalten wir mit Ihnen eine maßgeschneiderte Tour im Herzen des Nationalparks Écrins und der Matheysine: Dauer, Niveau, Etappen in Berghütten oder im Biwak, im Tempo, das Ihnen passt. Der Packesel trägt das Gepäck, Sie gehen einfach. Sagen Sie uns Ihre Wünsche, und wir entwerfen die Route."],
    ...
    ["Balade idéale pour une première randonnée en famille avec un âne. Accessible à tous, parfaite pour les familles avec enfants. Sentiers ombragés, passage en forêt et vue sur le plan d'eau — un moment doux et ressourçant au départ de Valbonnais.",
      "An ideal outing for a first family hike with a donkey. Accessible to all, perfect for families with children. Shaded paths, a stretch through the forest and a view over the water — a gentle, refreshing moment starting from Valbonnais.",
      "Ein idealer Ausflug für eine erste Familienwanderung mit einem Esel. Für alle zugänglich, perfekt für Familien mit Kindern. Schattige Wege, ein Abschnitt durch den Wald und Blick auf das Gewässer — ein sanfter, erholsamer Moment ab Valbonnais."],
    ["1 journée · 6-7h", "1 day · 6-7h", "1 Tag · 6-7 Std."],
    ["Modéré", "Moderate", "Mittel"],
    ["Randonnée à la journée avec un âne dans les Écrins", "Full-day hike with a donkey in the Écrins", "Tageswanderung mit einem Esel in den Écrins"],
    ["Une journée complète dans les alpages et sentiers du Parc National des Écrins, au départ de Péchal. Votre âne bâté porte pique-nique et affaires, vous profitez du panorama. Itinéraire adapté selon la saison et le groupe.",
      "A full day across the alpine pastures and trails of the Écrins National Park, starting from Péchal. Your pack donkey carries the picnic and gear while you enjoy the panorama. Route adapted to the season and the group.",
      "Ein ganzer Tag auf den Almen und Wegen des Nationalparks Écrins, ab Péchal. Ihr Packesel trägt Picknick und Gepäck, Sie genießen das Panorama. Route je nach Saison und Gruppe angepasst."],
    ...
    ["Randonnée délocalisée avec votre âne bâté autour du Sénepi (1769 m), entre Matheysine et Trièves, au départ de La Mure. Ce massif abrite le plus grand alpage organisé de France. Du sommet, panorama exceptionnel à 360° sur l'Obiou, le Taillefer, le lac de Monteynard et les grandes Alpes.",
      "An off-site hike with your pack donkey around the Sénepi (1,769 m), between the Matheysine and the Trièves, starting from La Mure. This massif is home to the largest organised mountain pasture in France. From the summit, an exceptional 360° panorama over the Obiou, the Taillefer, Lake Monteynard and the great Alps.",
      "Eine ausgelagerte Wanderung mit Ihrem Packesel rund um den Sénepi (1769 m), zwischen Matheysine und Trièves, ab La Mure. Dieses Massiv beherbergt die größte organisierte Alm Frankreichs. Vom Gipfel ein außergewöhnliches 360°-Panorama auf den Obiou, den Taillefer, den Lac de Monteynard und die großen Alpen."],
