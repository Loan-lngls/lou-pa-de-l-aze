...
(function () {
  ...
  var T = [
    ...
    ["Treks de 2 à 7 jours", "Treks of 2 to 7 days", "Treks von 2 bis 7 Tagen"],
    ...
    ["2 à 7 jours", "2 to 7 days", "2 bis 7 Tage"],
    ...
    ["De 2 à 7 jours, nous construisons l'itinérance avec vous : durée, niveau, étapes en refuge ou en bivouac, au rythme qui vous convient. L'âne porte les bagages, vous n'avez plus qu'à avancer. Dites-nous vos envies, on dessine le parcours.",
      "From 2 to 7 days, we build the journey with you: length, level, stages in mountain huts or bivouac, at the pace that suits you. The donkey carries the luggage, you just walk. Tell us what you're after and we'll map out the route.",
      "Von 2 bis 7 Tagen gestalten wir die Tour mit Ihnen: Dauer, Niveau, Etappen in Berghütten oder im Biwak, im Tempo, das Ihnen passt. Der Esel trägt das Gepäck, Sie gehen einfach. Sagen Sie uns Ihre Wünsche, und wir entwerfen die Route."],
    ...
    ["Multi-jours", "Multi-day", "Mehrtägig"],
